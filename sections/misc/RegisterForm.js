            ...
            <div className="tb-section-inner tb-wrap max-width-800">
                ...
                >
                    ...
                    <div className="tb-form-group">
                        ...
                        <input className="tb-form-control" id={17876522} type="text" name="username" placeholder="Enter your username" required />
                        <small className="tb-form-text">This should be your fullname (Format: firstname_lastname)</small>
                    </div>
                    <div className="tb-form-group">
                        <label>Password</label>
                        <input className="tb-form-control" type="password" id={18898223} name="password" placeholder="Enter password" required />
                    </div>
                    <div className="tb-form-group">
                    ...
                    <div className="tb-form-group">
                        ...
                        <input className="tb-form-control" id={33564998} type="text" name="education_course" placeholder="Enter your education" required />
                    </div>
                    <div className="tb-form-group">
                        <label>Education Institution</label>
                        <input className="tb-form-control" id={33564998} type="text" name="education_university" placeholder="Enter your university" required />
                    </div>
                    <div className="tb-form-group">
                        <label>Bio</label>
